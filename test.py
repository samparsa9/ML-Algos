...
class LinearRegression:
    def __init__(self, learning_rate=0.01): 
        ...
        # Initializing our parameters to start off as small random numbers
    ...
    # This is our cost function, which we have chosen to be Mean Squared Error (Sum of Squared Error leads to exploding gradients)
    ...
    def fit(self, x_features, z_features, y_labels):
        ...
        while not optimized:
            ...
            dw = (self.loss_function(x_features, z_features, y_labels, self.w + h, self.n, self.b) - self.loss_function(self.x_features, self.z_features, self.y_labels, self.w - h, self.n, self.b)) / (2 * h)
            # The formula for the partial derivative of our MSE loss function with respect to our second parameter, n, 
            # representing the slope, can be seen as follows
            dn = (self.loss_function(x_features, z_features, y_labels, self.w, self.n + h, self.b) - self.loss_function(self.x_features, self.z_features, self.y_labels, self.w, self.n - h, self.b)) / (2 * h)
            ...
            # Using our learning rate, we will add a tiny bit to our slope in the opposite signed direction of our partial derivative
